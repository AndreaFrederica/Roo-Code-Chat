...
const DESCRIPTION =
	"Privacy policy for Roo CHAT Cloud and marketing website. Learn how we handle your data and protect your privacy."
const PATH = "/privacy"
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Roo CHAT Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: September 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how ANH CHAT, Inc. (&quot;ANH CHAT,&quot; &quot;we,&quot;
					...
					<ul className="lead">
						...
						<li>
							create an account for, sign in to, or otherwise use <strong>Roo CHAT Cloud</strong> at{" "}
							<strong>app.roocode.com</strong> or through the ANH CHAT extension while authenticated to
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the ANH CHAT extension <strong>without</strong> connecting to a Cloud account,
							...
							<a
								...
								ANH CHAT Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>
								Your source code does not transit ANH CHAT servers unless you explicitly choose ANH CHAT
								as a model provider (proxy mode).
							</strong>{" "}
							When Roo CHAT Cloud is your model provider, your code briefly transits ANH CHAT servers only
							...
							TLS—to the model you select. ANH CHAT never stores, inspects, or trains on your code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in Roo CHAT Cloud so you
							can search and re‑use past conversations. Organization admins can disable this collection at
							any time.
						</li>
						<li>
							We collect only the data needed to operate Roo CHAT Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure Roo CHAT Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Your chosen model provider (direct client → provider TLS), or ANH CHAT (proxy
										mode; transit‑only) when you select ANH CHAT as the provider
									</td>
									<td className="border border-border px-4 py-2">
										ANH CHAT servers (except proxy mode; transit‑only, no storage); ad networks;
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										Roo CHAT Cloud (encrypted at rest)
									</td>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										ANH CHAT servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on ANH CHAT servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside Roo CHAT Cloud.
						</li>
						<li>
