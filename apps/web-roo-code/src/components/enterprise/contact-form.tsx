...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping ANH CHAT's enterprise solution."
			: "Fill out the form below to see ANH CHAT's enterprise capabilities in action."
