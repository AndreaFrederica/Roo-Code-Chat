...
export const sillyTavernExtensionsSchema = z
	.object({
		...
		depth_prompt: z
			.object({
				role: z
					.union([z.literal("system"), z.literal("assistant"), z.literal("user"), z.number(), z.string()])
					.optional(),
...
export const anhCharacterBookEntrySchema = z
	.object({
...
export const anhCharacterBookSchema = z
	.object({
		name: z.string(),
...
export const roleModeOverridesSchema = z
	.object({
...
export const roleMetadataSchema = z
	.object({
		...
		// STProfile 助手设定字段
		user_settings: z.string().optional(),
		assistant_settings: z.string().optional(),
		system_settings: z.string().optional(),
...
export const storylineArcSchema = z
	.object({
		id: z.string(),
		title: z.string(),
...
export const storylineFileSchema = z
	.object({
		roleUuid: z.string(),
		updatedAt: z.number(),
...
// Memory trait schema
export const memoryTraitSchema = z
	.object({
		name: z.string(),
		value: z.string(),
...
// Memory goal schema
export const memoryGoalSchema = z
	.object({
		value: z.string(),
		priority: z.number().optional(),
	})
...
export const memoryEpisodicRecordSchema = z
	.object({
		timestamp: z.number(),
		content: z.string(),
	})
...
export const storylineDataSchema = z
	.object({
...
export const rolePromptDataSchema = z
	.object({
		role: roleSchema,
