 ...
 *
 * This class manages the state for the marketplace view in the ANH CHAT extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the ANH CHAT extensions interface
